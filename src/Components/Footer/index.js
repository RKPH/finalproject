...
function Footer() {
  return (
    <footer className="bg-[#1D2128] h-60 w-full flex flex-col justify-between items-center text-white text-sm">
      ...
      <div name="Lower" className="m-5 flex justify-between w-5/6"> 
        <select class="w-[127px] h-[35px] pl-3 pr-[11px] pt-[7px] pb-1.5 bg-zinc-700 rounded-xl justify-center items-center gap-10 inline-flex">
            <option value="english" class="text-gray-400 text-sm font-normal font-['Raleway'] leading-snug">English</option>
